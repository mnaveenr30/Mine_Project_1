  ...
  <body>
    <div class="main-page">
      <div class="header-background">
        <div class="header">
          <ul>
             <li><a href="vote_home.jsp">LOG OUT</a></li>
      ...
      <div class="body-container">
        <div>
          <div class="text-container">
            ...
            <a href="voter_registration.jsp">Register for voting</a>
            <P></P>
            <p>if you already registered click here for vote.....</p>
                   <a href="vote_page.jsp">Click Here........!</a>
          </div>
        </div>
        <div>
